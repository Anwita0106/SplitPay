...
class TransactionOut(BaseModel):
    """
    Enriched view of money movement for the history list/detail pages.
    `method` is UPI for sandbox payments (id = payment id) and MANUAL for
    settlements a member recorded outside the app (id = settlement id).
    """
